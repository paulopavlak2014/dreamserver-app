...
class SeriesScreenState extends State<SeriesScreen> {
  ...
  /// Foca o primeiro item do grid (chamado ao trocar de aba)
  void focusGrid() {
      ...
      children: [
        ...
        Padding(
          ...
          child: Row(children: [
            ...
            const Spacer(),
            Text('${_filtered.length} séries', style: const TextStyle(color: Colors.grey, fontSize: 11)),
            IconButton(
              ...
              : _filtered.isEmpty
                  ...
                  : GridView.builder(
                      ...
                      itemBuilder: (_, i) => _SeriesTile(
                        key: ValueKey('series_${_filtered[i].id}_$i'),
                        series: _filtered[i],
