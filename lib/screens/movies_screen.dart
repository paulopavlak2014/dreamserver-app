...
class MoviesScreenState extends State<MoviesScreen> {
  ...
  /// Foca o primeiro filme do grid (chamado ao trocar de aba)
  void focusGrid() {
      ...
      children: [
        ...
        Padding(
          ...
          child: Row(children: [
            ...
            const Spacer(),
            Text('${_filtered.length} filmes', style: const TextStyle(color: Colors.grey, fontSize: 11)),
            IconButton(
              ...
              : _filtered.isEmpty
                  ...
                  : GridView.builder(
                      ...
                      itemBuilder: (_, i) => _MovieTile(
                        key: ValueKey('movie_${_filtered[i].id}_$i'),
                        movie: _filtered[i],
